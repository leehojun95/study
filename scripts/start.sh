...
nohup java -jar -Dspring.config.location=classpath:/application.properties,/home/ec2-user/app3/application-real-db.properties, /home/ec2-user/app3/application-private.properties $JAR_FILE > $APP_LOG 2> $ERROR_LOG &
